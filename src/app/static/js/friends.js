        ...
        .then((data) => {
          ...
          data.forEach((person) => {
            ...
            li.addEventListener("click", () => {
              ...
              results.innerHTML = "";
              fetch(
                `/friend_requests/send?q=${encodeURIComponent(person.username)}`,
                {
                  method: "POST",
...
function createFriendRequest(username, createdAt) {
  ...
  friendReq.className =
    "border border-gray-700 rounded-xl p-2 mb-3 bg-white dark:bg-gray-800";
...
function renderTable(friends) {
  ...
  friends.forEach((friend) => {
    ...
    tr.className =
      "hover:bg-gray-100 dark:hover:bg-dark-secondary border border-gray-200 dark:border-dark-border";
    tr.innerHTML = `
